...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(assets("img/icon.png")); ?>" type="image/png">
...
<body>
    ...
    <script src="<?php echo e(assets("assets/js/jquery.form.js")); ?>"></script>
    <script src="<?php echo e(assets("assets/js/jquery-ui.js")); ?>"></script>
